<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		...
		<p class="copy-right">&copy 2017 Elite shoppy. All rights reserved | Design by <a href="http://Dilignet Corp.com/">Dilignet Corp</a></p>
	</div>
</div>
<!-- //footer -->
	...
	$(document).ready(function(){
		$("#signupUser").click(function(){
			...
			$.ajax({
				...
				method:"POST",
				data: 'action='+action+'&name='+name+'&phone='+phone+'&email='+email+'&password='+password,
				dataType:"JSON"
			}).done(function(data){
				console.log(data);
