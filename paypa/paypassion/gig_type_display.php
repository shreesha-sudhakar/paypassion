		...
		if (isset($_POST["action"])){
			...
			switch($action){
				...
				if(isset($_POST['id'])){
					...
					$display=mysqli_query($connect,"SELECT gig_sub_type.`gig_type_name`,area.gig_area FROM `gig_sub_type`,area WHERE area.area_id=gig_sub_type.area_id and area.area_id='$area_id'");
